...
public class RunIterator implements Iterator {
  ...
  private Run headNode;
  private Run currentNode;
  private int size;
  private int iter=0;
  /**
  ...
  // the encoding.
  RunIterator(Run firstNode,int size) {
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
    int[] items = {currentNode.getRed(),currentNode.getGreen(),currentNode.getBlue(),currentNode.getRunLength()};
    iter++;
